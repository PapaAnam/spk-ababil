...
<div class="row">
  <div class="col-md-6">
    <div class="box box-primary">
      ...
      <div class="box-body">
        <form method="get" action="{{url('progress/tugas')}}" class="form-horizontal">
  ...
  <div class="col-md-6">
    <div class="box box-primary">
      ...
      <div class="box-body">
        <form method="get" action="{{url('progress/tugas')}}" class="form-horizontal">
          @include('select2-no-tags',['labelSize'=>3,'selectSize'=>8,'id'=>'proyek','label'=>'Pilih Proyek','selectData'=>$listProyek,'selected'=>request()->query('proyek')])
          <div class="form-group">
            <label class="col-lg-3 control-label"></label>
            <div class="col-sm-6">
              <button type="submit" class="btn btn-primary btn-flat">Lihat</button>
